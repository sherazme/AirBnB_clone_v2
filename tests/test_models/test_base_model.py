...
class TestBasemodel(unittest.TestCase):
    ...
    def setUp(self):
        """Performs some operations before running tests"""
        pass

    def tearDown(self):
        """Performs some operations after running tests"""
        try:
            os.remove('file.json')
        except Exception:
            pass
    ...
    def test_todict(self):
        ...
        # Tests to_dict datetime attributes
    ...
    def test_created_at(self):
        """Tests created_at type"""
        new = self.value()
        self.assertEqual(type(new.created_at), datetime)

    def test_updated_at(self):
        """Tests updated_at type"""
        new = self.value()
